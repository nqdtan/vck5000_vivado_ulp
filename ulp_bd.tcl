...
proc create_root_design { parentCell kernel } {
  ...
  # alternating MC_00 and MC_01 connected to the kernel M_AXI ports {m_axi_a, m_axi_b, m_axi_c}
  ...
  connect_bd_intf_net -intf_net ${kernel}_0_m_axi_a [get_bd_intf_pins axi_noc_0/S00_AXI] [get_bd_intf_pins ${kernel}_0/m_axi_a]
  connect_bd_intf_net -intf_net ${kernel}_0_m_axi_b [get_bd_intf_pins axi_noc_0/S01_AXI] [get_bd_intf_pins ${kernel}_0/m_axi_b]
  connect_bd_intf_net -intf_net ${kernel}_0_m_axi_c [get_bd_intf_pins axi_noc_0/S02_AXI] [get_bd_intf_pins ${kernel}_0/m_axi_c]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_ports blp_s_aclk_kernel_00] [get_bd_pins axi_noc_0/aclk0] [get_bd_pins ii_level0_wire_0/blp_s_aclk_kernel_00] [get_bd_pins ${kernel}_0/ap_clk] [get_bd_pins smartconnect_0/aclk1]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ${kernel}_0/ap_rst_n]
  ...
  # alternating MC_00 and MC_01 connected to the kernel M_AXI ports
  assign_bd_address -offset 0x00C000000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces ${kernel}_0/m_axi_a] [get_bd_addr_segs BLP_M_INI_MC_00/Reg] -force
  assign_bd_address -offset 0x00C000000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces ${kernel}_0/m_axi_b] [get_bd_addr_segs BLP_M_INI_MC_01/Reg] -force
  assign_bd_address -offset 0x00C000000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces ${kernel}_0/m_axi_c] [get_bd_addr_segs BLP_M_INI_MC_00/Reg] -force
