...
proc create_root_design { parentCell } {
  ...
  # Create instance: data_mover_mm2mm_0, and set properties
  set data_mover_mm2mm_0 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:data_mover_mm2mm:1.0 data_mover_mm2mm_0 ]
  ...
  connect_bd_intf_net -intf_net ai_engine_0_M00_AXI [get_bd_intf_pins ai_engine_0/M00_AXI] [get_bd_intf_pins axi_noc_aie_prog/S00_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M01_AXI [get_bd_intf_pins ai_engine_0/M01_AXI] [get_bd_intf_pins axi_noc_aie_prog/S01_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M02_AXI [get_bd_intf_pins ai_engine_0/M02_AXI] [get_bd_intf_pins axi_noc_aie_prog/S02_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M03_AXI [get_bd_intf_pins ai_engine_0/M03_AXI] [get_bd_intf_pins axi_noc_aie_prog/S03_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M04_AXI [get_bd_intf_pins ai_engine_0/M04_AXI] [get_bd_intf_pins axi_noc_aie_prog/S04_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M05_AXI [get_bd_intf_pins ai_engine_0/M05_AXI] [get_bd_intf_pins axi_noc_aie_prog/S05_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M06_AXI [get_bd_intf_pins ai_engine_0/M06_AXI] [get_bd_intf_pins axi_noc_aie_prog/S06_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M07_AXI [get_bd_intf_pins ai_engine_0/M07_AXI] [get_bd_intf_pins axi_noc_aie_prog/S07_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M08_AXI [get_bd_intf_pins ai_engine_0/M08_AXI] [get_bd_intf_pins axi_noc_aie_prog/S08_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M09_AXI [get_bd_intf_pins ai_engine_0/M09_AXI] [get_bd_intf_pins axi_noc_aie_prog/S09_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M10_AXI [get_bd_intf_pins ai_engine_0/M10_AXI] [get_bd_intf_pins axi_noc_aie_prog/S10_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M11_AXI [get_bd_intf_pins ai_engine_0/M11_AXI] [get_bd_intf_pins axi_noc_aie_prog/S11_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M12_AXI [get_bd_intf_pins ai_engine_0/M12_AXI] [get_bd_intf_pins axi_noc_aie_prog/S12_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M13_AXI [get_bd_intf_pins ai_engine_0/M13_AXI] [get_bd_intf_pins axi_noc_aie_prog/S13_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M14_AXI [get_bd_intf_pins ai_engine_0/M14_AXI] [get_bd_intf_pins axi_noc_aie_prog/S14_AXI]
  connect_bd_intf_net -intf_net ai_engine_0_M15_AXI [get_bd_intf_pins ai_engine_0/M15_AXI] [get_bd_intf_pins axi_noc_aie_prog/S15_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ic_user_M01_AXI [get_bd_intf_pins axi_ic_user/M01_AXI] [get_bd_intf_pins data_mover_mm2mm_0/s_axi_control]
  ...
  connect_bd_intf_net -intf_net axi_noc_aie_prog_M01_AXI [get_bd_intf_pins axi_noc_aie_prog/M01_AXI] [get_bd_intf_pins smartconnect_1/S01_AXI]
  ...
  connect_bd_intf_net -intf_net data_mover_mm2mm_0_m_axi_data_ext [get_bd_intf_pins axi_noc_kernel0/S00_AXI] [get_bd_intf_pins data_mover_mm2mm_0/m_axi_data_ext]
  connect_bd_intf_net -intf_net data_mover_mm2mm_0_m_axi_data_int [get_bd_intf_pins data_mover_mm2mm_0/m_axi_data_int] [get_bd_intf_pins smartconnect_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins axi_noc_aie_prog/S16_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net ai_engine_0_m00_axi_aclk [get_bd_pins ai_engine_0/m00_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk2]
  connect_bd_net -net ai_engine_0_m01_axi_aclk [get_bd_pins ai_engine_0/m01_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk3]
  connect_bd_net -net ai_engine_0_m02_axi_aclk [get_bd_pins ai_engine_0/m02_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk4]
  connect_bd_net -net ai_engine_0_m03_axi_aclk [get_bd_pins ai_engine_0/m03_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk5]
  connect_bd_net -net ai_engine_0_m04_axi_aclk [get_bd_pins ai_engine_0/m04_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk6]
  connect_bd_net -net ai_engine_0_m05_axi_aclk [get_bd_pins ai_engine_0/m05_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk7]
  connect_bd_net -net ai_engine_0_m06_axi_aclk [get_bd_pins ai_engine_0/m06_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk8]
  connect_bd_net -net ai_engine_0_m07_axi_aclk [get_bd_pins ai_engine_0/m07_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk9]
  connect_bd_net -net ai_engine_0_m08_axi_aclk [get_bd_pins ai_engine_0/m08_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk10]
  connect_bd_net -net ai_engine_0_m09_axi_aclk [get_bd_pins ai_engine_0/m09_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk11]
  connect_bd_net -net ai_engine_0_m10_axi_aclk [get_bd_pins ai_engine_0/m10_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk12]
  connect_bd_net -net ai_engine_0_m11_axi_aclk [get_bd_pins ai_engine_0/m11_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk13]
  connect_bd_net -net ai_engine_0_m12_axi_aclk [get_bd_pins ai_engine_0/m12_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk14]
  connect_bd_net -net ai_engine_0_m13_axi_aclk [get_bd_pins ai_engine_0/m13_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk15]
  connect_bd_net -net ai_engine_0_m14_axi_aclk [get_bd_pins ai_engine_0/m14_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk16]
  connect_bd_net -net ai_engine_0_m15_axi_aclk [get_bd_pins ai_engine_0/m15_axi_aclk] [get_bd_pins axi_noc_aie_prog/aclk17]
  ...
  connect_bd_net -net reset_controllers_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins data_mover_mm2mm_0/ap_rst_n] [get_bd_pins reset_controllers/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins emb_mem_gen_0/regcea] [get_bd_pins emb_mem_gen_0/regceb] [get_bd_pins xlconstant_0/dout]
  ...
  assign_bd_address -offset 0x00C100000000 -range 0x000300000000 -target_address_space [get_bd_addr_spaces data_mover_mm2mm_0/m_axi_data_ext] [get_bd_addr_segs BLP_M_M00_INI_0/Reg] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces data_mover_mm2mm_0/m_axi_data_int] [get_bd_addr_segs ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x020100000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces data_mover_mm2mm_0/m_axi_data_int] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x020200001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces BLP_S_AXI_CTRL_USER_00] [get_bd_addr_segs data_mover_mm2mm_0/s_axi_control/reg0] -force
